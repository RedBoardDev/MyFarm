...
void button_toggle_dark_mode(rpg_t *rpg)
{
    if (rpg->params.dark_mode) {
        ...
        rpg->spritesheet[SP_BUTTON_ON_OFF_LUM].rect.left = rpg->spritesheet[SP_BUTTON_ON_OFF_LUM].rect.width;
    }
}
...
void button_toggle_show_fps(rpg_t *rpg)
{
    if (rpg->params.show_fps) {
        ...
        rpg->spritesheet[SP_BUTTON_ON_OFF_FPS].rect.left = rpg->spritesheet[SP_BUTTON_ON_OFF_FPS].rect.width;
    } else {
