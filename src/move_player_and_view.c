...
void move_player_and_view(rpg_t *rpg)
{
    ...
    if (rpg->screen[SC_BASE].active) {
        move_player_and_view_horizontal(rpg, rpg->imgs_colors.main_house, (sfVector2f){rpg->spritesheet[SP_PLAYER].pos.x - 650, rpg->spritesheet[SP_PLAYER].pos.y - 810}, false);
        move_player_and_view_vertical(rpg, rpg->imgs_colors.main_house, (sfVector2f){rpg->spritesheet[SP_PLAYER].pos.x - 650, rpg->spritesheet[SP_PLAYER].pos.y - 810}, false);
        teleport_player_scene(rpg, rpg->imgs_colors.main_house, (sfVector2f){rpg->spritesheet[SP_PLAYER].pos.x - 650, rpg->spritesheet[SP_PLAYER].pos.y - 810});
    }
