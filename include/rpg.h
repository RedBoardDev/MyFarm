...
*/
    ...
    shop_button4, how_play, quest_seller, quest_soldiers, nothing, nothing,  \
    ...
    button_next_grotte, nothing, nothing, button_resume_game, \
    button_option_game, button_leave_game, nothing, \
